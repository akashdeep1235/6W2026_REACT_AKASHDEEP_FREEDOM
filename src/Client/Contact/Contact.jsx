    ...
    <div className="container">
      <div className="row g-5">
        <div className="col-lg-6 wow fadeIn" data-wow-delay="0.1s">
          ...
          <p className="mb-4">
            The contact form is currently inactive. Get Link functional and working
            contact form with Ajax &amp; PHP in Link few minutes. Just copy and
            paste the files, add Link little code and you're done.{" "}
